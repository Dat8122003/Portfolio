...
const lines = [
  ...
  "    ],",
  "",
  "    p2Title: `"Bài thí nghiệm trực tuyến khảo sát nhiệt độ Curie của chất sắt từ`",",
  ...
  "",
  "];",
  "writeFileSync(`"src/hooks/i18n.ts`", lines.join(`"`n`"), `"utf8`");",
  "const v = require(`"fs`").readFileSync(`"src/hooks/i18n.ts`", `"utf8`");",
  "console.log(`"Đạt:`", v.includes(`"Đạt`"));",
  "console.log(`"?:`", v.includes(`"`?`"));",
  "console.log(`"contactCv:`", v.includes(`"contactCv`"));"
